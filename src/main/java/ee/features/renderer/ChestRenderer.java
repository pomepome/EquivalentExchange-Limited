...
{
	private final ResourceLocation texture = new ResourceLocation("ee", "textures/blocks/alchemy_chest.png");
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float var8)
	{
		...
		TileEntityAlchChest chestTile = (TileEntityAlchChest) tile;
