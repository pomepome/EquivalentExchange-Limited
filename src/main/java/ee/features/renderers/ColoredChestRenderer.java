...
public class ColoredChestRenderer extends TileEntitySpecialRenderer
{

	private final ResourceLocation texture = new ResourceLocation("ee", "textures/blocks/alch_color.png");
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float var8)
	{
		...
		TileEntityColoredAlchChest chestTile = (TileEntityColoredAlchChest) tile;
