...
public class TileEntityAggregator extends TileEntity implements ISidedInventory {
    ...
    {
        return p_94041_1_ == 1 ? false : isUseableForRes(p_94041_2_);
    }
    ...
    public boolean isUseableForRes(ItemStack is)
    {
    	Block b = Block.getBlockFromItem(is.getItem());
    	return (b != null) && (b == Blocks.cobblestone || b == Blocks.netherrack || b == Blocks.soul_sand);
    }
}
