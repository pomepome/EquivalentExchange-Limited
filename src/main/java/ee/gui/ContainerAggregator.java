...
public class ContainerAggregator extends Container {
	...
	private TileEntityAggregator tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;

    public ContainerAggregator(InventoryPlayer p_i1812_1_, TileEntityAggregator p_i1812_2_)
    {
    	setUp(p_i1812_1_,p_i1812_2_);
    }
    public ContainerAggregator(){}

    public void setUp(InventoryPlayer p_i1812_1_, TileEntityAggregator p_i1812_2_)
    {
    	this.tileFurnace = p_i1812_2_;
        this.addSlotToContainer(new Slot(p_i1812_2_, 0, 56, 17));
        this.addSlotToContainer(new SlotFurnace(p_i1812_1_.player, p_i1812_2_, 1, 116, 35));
        int i;
